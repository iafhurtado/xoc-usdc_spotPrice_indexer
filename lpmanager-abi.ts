export const lpManagerAbi = [
  ...
  { inputs: [], name: "UniswapV3TokenizedLp_AlreadySet", type: "error" },
  ...
  },
  {
    ...
    name: "setActiveDepositorWhitelist",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
